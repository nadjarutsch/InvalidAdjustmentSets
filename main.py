...
def generate_data(variables: list, cfg: DictConfig, seed: int) -> np.ndarray:
    ...
    Returns:
    - np.ndarray: A 2D array of shape (len(variables), sample_size), where each row corresponds
                to a variable and each column to a sample. Data is generated by adding Gaussian
